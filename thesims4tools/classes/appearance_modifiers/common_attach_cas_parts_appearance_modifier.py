...
from thesims4tools.enums.common_appearance_modifier_type import CommonAppearanceModifierType
...
class CommonAttachCASPartsAppearanceModifier(AppearanceModifier.BaseAppearanceModification, HasLog):
    ...
    .. note:: To see an example of this appearance modifier in action, run the command `ts4t_testing.toggle_example_appearance_modifier_buff` in the console. (The Sim will have bare feet)
...
if not ON_RTD:
    ...
    def _ts4t_testing_apply_example_bare_feet_buff(output: CommonConsoleCommandOutput, sim_info: SimInfo=None):
        if sim_info is None:
            return False
