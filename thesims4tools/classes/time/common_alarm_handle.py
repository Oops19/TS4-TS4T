...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.print_current_time', 'Prints the current time.')
def _ts4t_print_current_time(output: CommonConsoleCommandOutput):
    output('Current time')
