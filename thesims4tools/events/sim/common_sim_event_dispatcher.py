...
from thesims4tools.events.sim.events.sim_added_occult_type import S4CLSimAddedOccultTypeEvent
from thesims4tools.events.sim.events.sim_after_set_current_outfit import S4CLSimAfterSetCurrentOutfitEvent
from thesims4tools.events.sim.events.sim_buff_added import S4CLSimBuffAddedEvent
from thesims4tools.events.sim.events.sim_buff_removed import S4CLSimBuffRemovedEvent
from thesims4tools.events.sim.events.sim_changed_age import S4CLSimChangedAgeEvent
from thesims4tools.events.sim.events.sim_changed_gender_options_body_frame import S4CLSimChangedGenderOptionsBodyFrameEvent
...
from thesims4tools.events.sim.events.sim_changed_gender_options_clothing_preference import S4CLSimChangedGenderOptionsClothingPreferenceEvent
from thesims4tools.events.sim.events.sim_changed_gender import S4CLSimChangedGenderEvent
from thesims4tools.events.sim.events.sim_changed_occult_type import S4CLSimChangedOccultTypeEvent
from thesims4tools.events.sim.events.sim_changed_gender_options_can_be_impregnated import S4CLSimChangedGenderOptionsCanBeImpregnatedEvent
from thesims4tools.events.sim.events.sim_changed_gender_options_toilet_usage import S4CLSimChangedGenderOptionsToiletUsageEvent
from thesims4tools.events.sim.events.sim_changing_occult_type import S4CLSimChangingOccultTypeEvent
from thesims4tools.events.sim.events.sim_died import S4CLSimDiedEvent
from thesims4tools.events.sim.events.sim_pre_despawned import S4CLSimPreDespawnedEvent
from thesims4tools.events.sim.events.sim_initialized import S4CLSimInitializedEvent
from thesims4tools.events.sim.events.sim_loaded import S4CLSimLoadedEvent
from thesims4tools.events.sim.events.game_object_added_to_sim_inventory import S4CLGameObjectAddedToSimInventoryEvent
from thesims4tools.events.sim.events.game_object_pre_removed_from_sim_inventory import S4CLGameObjectPreRemovedFromSimInventoryEvent
from thesims4tools.events.sim.events.sim_removed_occult_type import S4CLSimRemovedOccultTypeEvent
from thesims4tools.events.sim.events.sim_revived import S4CLSimRevivedEvent
from thesims4tools.events.sim.events.sim_set_current_outfit import S4CLSimSetCurrentOutfitEvent
from thesims4tools.events.sim.events.sim_skill_leveled_up import S4CLSimSkillLeveledUpEvent
from thesims4tools.events.sim.events.sim_spawned import S4CLSimSpawnedEvent
from thesims4tools.events.sim.events.sim_trait_added import S4CLSimTraitAddedEvent
from thesims4tools.events.sim.events.sim_trait_removed import S4CLSimTraitRemovedEvent
