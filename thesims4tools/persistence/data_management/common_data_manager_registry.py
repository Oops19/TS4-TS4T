...
from thesims4tools.persistence.data_management.common_data_manager import CommonDataManager
...
class CommonDataManagerRegistry(CommonService, HasClassLog):
    ...
    .. code-block:: python
        ...
        class ExampleDataManager(CommonDataManager):
            ...
            def persistence_services(self) -> Tuple[CommonPersistenceService]:
                from thesims4tools.persistence.persistence_services.common_hidden_household_persistence_service import \
                    CommonHiddenHouseholdPersistenceService
                from thesims4tools.persistence.persistence_services.common_file_persistence_service import \
    ...
    def save_data(self) -> None:
        ...
        from thesims4tools.persistence.common_game_object_data_storage import _CommonGameObjectDataStorageMetaclass
        ...
        from thesims4tools.persistence.common_sim_data_storage import _CommonSimDataStorageMetaclass
