...
from thesims4tools.utils.common_log_registry import CommonLogRegistry, CommonLog
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.disable_vanilla_logs',
    'Disable the Vanilla Logs.',
    command_aliases=(
        'ts4t.disablevanillalogs',
    )
)
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.clear_log_times', 'Clear the stop watches for the vanilla logs', show_with_help_command=False)
