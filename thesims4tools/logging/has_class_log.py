...
from thesims4tools.mod_support.has_class_mod_identity import HasClassModIdentity
from thesims4tools.mod_support.mod_identity import CommonModIdentity

if TYPE_CHECKING:
    from thesims4tools.utils.common_log_registry import CommonLog, CommonLogRegistry
