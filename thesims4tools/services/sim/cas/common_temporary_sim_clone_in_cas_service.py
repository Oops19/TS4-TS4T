...
from thesims4tools.utils.sims.common_sim_spawn_utils import CommonSimSpawnUtils
...
class CommonEditSimCloneInCASService(CommonService, HasLog):
    ...
    def _setup_sim_clone_outfit(
        ...
        # from thesims4tools.utils.sims.common_occult_utils import CommonOccultUtils
...
def _ts4t_modify_sim_clone(output: CommonConsoleCommandOutput, sim_info: SimInfo=None):
    if sim_info is None:
        return
