...
if TYPE_CHECKING:
    from thesims4tools.utils.common_log_registry import CommonLog
...
class CommonConsoleCommand(metaclass=_CommonConsoleCommandMetaclass):
    ...
    .. note:: To see an example command, run the command :class:`ts4t_testing.example_command` in the in-game console.
    ...
    .. code-block:: python
        ...
        @CommonConsoleCommand(ModInfo.get_identity(), 'ts4t_testing.example_command', 'Print an example message', command_aliases=('ts4t_testing.examplecommand',), command_arguments=(CommonConsoleCommandArgument('thing_to_print', 'Text or Num', 'If specified, this value will be printed to the console. Default is "24".'),))
...
class CommonConsoleCommandService(CommonService, HasClassLog):
    ...
    def _parse_arguments(cls, full_arg_spec: inspect.FullArgSpec, args: Tuple[str], arg_names: Tuple[str], kwargs_by_name, kwargs: Dict[str, Any], output: Union[CommonConsoleCommandOutput, Output]):
        ...
        from thesims4tools.services.commands.common_console_command_parameters import CommonConsoleCommandParameter,\
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.example_command',
    'Print an example message',
    command_aliases=('ts4t_testing.alternativeexamplecommand',),
    command_arguments=(
