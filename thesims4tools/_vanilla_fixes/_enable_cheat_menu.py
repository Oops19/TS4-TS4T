...
from thesims4tools.utils.common_keyboard_utils import CommonKeyboardUtils, CommonKey
...
log = CommonLogRegistry().register_log(ModInfo.get_identity(), 'ts4t_extra_cheat_menu_log')
