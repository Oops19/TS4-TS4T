...
class CommonChooseOutfitDialog(CommonChooseDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_outfit_dialog` in the in-game console.
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_choose_outfit_dialog',
