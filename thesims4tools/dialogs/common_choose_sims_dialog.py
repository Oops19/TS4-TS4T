...
from thesims4tools.dialogs.common_choose_sim_dialog import CommonChooseSimDialog
...
class CommonChooseSimsDialog(CommonChooseSimDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_sims_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_choose_sims_dialog'
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_choose_sims_dialog',
