...
from thesims4tools.dialogs.common_choose_dialog import CommonChooseDialog
from thesims4tools.dialogs.common_dialog_navigation_button_tag import CommonDialogNavigationButtonTag
from thesims4tools.dialogs.custom_dialogs.picker_dialogs.common_ui_object_category_picker import \
    CommonUiObjectCategoryPicker

from thesims4tools.dialogs.option_dialogs.options.objects.common_dialog_option_category import \
    CommonDialogObjectOptionCategory
from thesims4tools.dialogs.utils.common_dialog_utils import CommonDialogUtils
...
class CommonChooseObjectDialog(CommonChooseDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_object_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_choose_object_dialog'
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_choose_object_dialog',
