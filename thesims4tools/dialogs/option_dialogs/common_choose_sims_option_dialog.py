...
from thesims4tools.dialogs.common_choose_sims_dialog import CommonChooseSimsDialog
...
class CommonChooseSimsOptionDialog(CommonChooseOptionsDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_sims_option_dialog` in the in-game console.
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_choose_sims_option_dialog',
