...
from thesims4tools.dialogs.common_choose_response_dialog import CommonChooseResponseDialog
from thesims4tools.dialogs.option_dialogs.common_choose_response_option_dialog import \
    CommonChooseResponseOptionDialog
from thesims4tools.dialogs.option_dialogs.options.response.common_dialog_button_option import \
...
from thesims4tools.services.commands.common_console_command_parameters import \
...
class CommonChooseButtonOptionDialog(CommonChooseResponseOptionDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_button_option_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_choose_button_option_dialog'
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_choose_button_option_dialog',
