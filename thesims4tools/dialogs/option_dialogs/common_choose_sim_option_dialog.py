...
class CommonChooseSimOptionDialog(CommonChooseOptionDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_sim_option_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_choose_sim_option_dialog'
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_choose_sim_option_dialog',
