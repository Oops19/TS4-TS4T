...
from thesims4tools.dialogs.choose_objects_dialog import CommonChooseObjectsDialog
from thesims4tools.dialogs.option_dialogs.common_choose_options_dialog import CommonChooseOptionsDialog
...
class CommonChooseObjectsOptionDialog(CommonChooseOptionsDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_objects_option_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_choose_objects_option_dialog'
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_choose_objects_option_dialog',
