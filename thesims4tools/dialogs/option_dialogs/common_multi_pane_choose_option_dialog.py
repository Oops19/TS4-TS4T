...
from thesims4tools.dialogs.common_choice_outcome import CommonChoiceOutcome
from thesims4tools.dialogs.common_multi_pane_choose_dialog import CommonMultiPaneChooseDialog
from thesims4tools.dialogs.option_dialogs.common_choose_object_option_dialog import CommonChooseObjectOptionDialog
from thesims4tools.dialogs.option_dialogs.common_choose_option_dialog import CommonChooseOptionDialog
from thesims4tools.dialogs.option_dialogs.common_option_dialog import CommonOptionDialog
from thesims4tools.dialogs.option_dialogs.options.common_dialog_option import CommonDialogOption
...
from thesims4tools.dialogs.option_dialogs.options.objects.common_dialog_object_option import CommonDialogObjectOption
...
class CommonMultiPaneChooseOptionDialog(CommonOptionDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_multi_pane_choose_option_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_multi_pane_choose_option_dialog'
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_multi_pane_choose_option_dialog',
