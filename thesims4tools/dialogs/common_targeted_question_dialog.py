...
class CommonTargetedQuestionDialog(CommonDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_targeted_question_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_targeted_question_dialog'
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_targeted_question_dialog',
