...
from thesims4tools.dialogs._common_ui_dialog_multi_text_input_ok_cancel import _CommonUiDialogMultiTextInputOkCancel
from thesims4tools.dialogs._common_ui_dialog_text_input_ok_cancel import _CommonUiDialogTextInputOkCancel
from thesims4tools.dialogs.common_choice_outcome import CommonChoiceOutcome
from thesims4tools.dialogs.common_dialog import CommonDialog
from thesims4tools.dialogs.common_input_text_field import CommonInputTextField
from thesims4tools.enums.common_character_restrictions import CommonCharacterRestriction
...
class CommonInputMultiTextDialog(CommonDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_input_multi_text_dialog` in the in-game console.
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_input_multi_text_dialog',
