...
from thesims4tools.enums.common_object_delivery_method import CommonObjectDeliveryMethod
...
from thesims4tools.utils.sims.common_sim_inventory_utils import CommonSimInventoryUtils
...
class CommonPurchaseObjectsDialog(CommonChooseDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_purchase_objects_dialog` in the in-game console.
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_purchase_objects_dialog',
