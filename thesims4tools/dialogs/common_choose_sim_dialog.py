...
class CommonChooseSimDialog(CommonChooseDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_sim_dialog` in the in-game console.
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_choose_sim_dialog',
