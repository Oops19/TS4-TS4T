...
from thesims4tools.dialogs.common_ui_response_dialog import CommonUiResponseDialog
...
class CommonChooseResponseDialog(CommonDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_choose_response_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_choose_response_dialog'
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_choose_response_dialog',
