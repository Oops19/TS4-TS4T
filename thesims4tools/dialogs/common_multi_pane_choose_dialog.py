...
from thesims4tools.dialogs.choose_object_dialog import CommonChooseObjectDialog
...
from thesims4tools.dialogs.custom_dialogs.picker_dialogs.common_ui_multi_picker import CommonUiMultiPicker
...
class CommonMultiPaneChooseDialog(CommonDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_multi_pane_choose_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_multi_pane_choose_dialog'
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.show_multi_pane_choose_dialog',
