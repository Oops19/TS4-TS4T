...
class CommonInputFloatDialog(CommonDialog):
    ...
    .. note:: To see an example dialog, run the command :class:`ts4t_testing.show_input_float_dialog` in the in-game console.
    ...
    def log_identifier(self) -> str:
        return 'ts4t_input_float_dialog'
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.show_input_float_dialog',
