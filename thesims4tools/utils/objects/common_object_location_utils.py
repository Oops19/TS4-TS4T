...
from thesims4tools.utils.objects.common_object_type_utils import CommonObjectTypeUtils
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.print_bone_position_on_sim',
