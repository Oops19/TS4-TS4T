...
from thesims4tools.enums.common_object_state_ids import CommonObjectStateId
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.print_object_states',
...
def _common_modify_object_state(output: CommonConsoleCommandOutput, game_object: GameObject) -> bool:
    ...
    from thesims4tools.debug.dialogs.common_change_object_state_dialog import CommonChangeObjectStateDialog
