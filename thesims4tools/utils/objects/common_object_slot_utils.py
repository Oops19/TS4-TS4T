...
from thesims4tools.dtos.common_object_containment_slot import CommonObjectContainmentSlot
from thesims4tools.enums.common_slot_type import CommonSlotType
