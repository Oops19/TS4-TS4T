...
from thesims4tools.classes.effects.common_visual_effect import CommonVisualEffect
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.play_visual_effect',
    'Play a VFX on a Sim. Run `ts4t.stop_all_visual_effects` to stop the visual effect.',
    command_arguments=(
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.play_visual_effect_object',
    'Play a VFX on an Object. Run `ts4t.stop_all_visual_effects` to stop the visual effect.',
    command_arguments=(
        CommonConsoleCommandArgument('effect_name', 'Text', 'The name of an effect to play.'),
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.stop_visual_effects_sim',
    'Stop all running effects that were started via `ts4t.play_visual_effect` on a Sim.',
    command_arguments=(
        CommonConsoleCommandArgument('sim_info', 'Sim Id or Name', 'The Id or Name of a Sim to attach the VFX to.', is_optional=True, default_value='Active Sim'),
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.stop_visual_effects_object',
    'Stop all running effects that were started via `ts4t.play_visual_effect` on a Game Object.',
    command_arguments=(
        CommonConsoleCommandArgument('game_object', 'Instance Id of Object', 'The instance id of an Object to attach the VFX to.'),
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.stop_all_visual_effects',
    'Stop all running effects that were started via `ts4t.play_visual_effect`.'
)
