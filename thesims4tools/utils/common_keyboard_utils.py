...
from thesims4tools.enums.common_key import CommonKey
...
try:
    if os.name == 'nt':
        import _ts4t_ctypes_module
        _user32 = _ts4t_ctypes_module.WinDLL('user32', use_last_error=True)
        if _user32 is not None:
            _user32.GetKeyState.restype = _ts4t_ctypes_module.c_uint16
