...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.print_enacted_street_policies', 'Print a list of enacted policies.')
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.print_balloted_street_policies', 'Print a list of balloted policies.')
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.print_dormant_street_policies', 'Print a list of dormant policies.')
