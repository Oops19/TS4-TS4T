...
from thesims4tools.enums.relationship_bits_enum import CommonRelationshipBitId
from thesims4tools.enums.relationship_tracks_enum import CommonRelationshipTrackId
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.print_relationship_bits',
    ...
    command_aliases=(
        'ts4t_testing.printrelationshipbits',
        'ts4t_testing.print_rel_bits',
        'ts4t_testing.printrelbits'
    )
)
