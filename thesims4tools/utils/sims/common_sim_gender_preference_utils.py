...
@CommonConsoleCommand(
    ...
    'ts4t.set_world_sexually_exploring',
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.setgenderpref',
        'ts4t.set_gender_preference',
        'ts4t.setgenderpreference',
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.set_gender_pref_of_all_sims',
    ...
    command_aliases=(
        'ts4t.setgenderprefofallsims',
        'ts4t.setgenderpreferenceofallsims',
        'ts4t.set_gender_preference_of_all_sims',
        'ts4t.set_all_gender_preferences',
        'ts4t.setallgenderpreferences',
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.set_gender_pref_of_all_female_sims',
    ...
    command_aliases=(
        'ts4t.setgenderprefofallfemalesims',
        'ts4t.setgenderpreferenceofallfemalesims',
        'ts4t.set_gender_preference_of_all_female_sims',
        'ts4t.set_all_female_gender_preferences',
        'ts4t.setallfemalegenderpreferences',
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.set_gender_pref_of_all_male_sims',
    ...
    command_aliases=(
        'ts4t.setgenderprefofallmalesims',
        'ts4t.setgenderpreferenceofallmalesims',
        'ts4t.set_gender_preference_of_all_male_sims',
        'ts4t.set_all_male_gender_preferences',
        'ts4t.setallmalegenderpreferences',
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.printgenderpref',
        'ts4t.print_gender_preference',
        'ts4t.printgenderpreference',
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.apply_default_gender_pref',
    'Apply the default Gender preferences for ROMANTIC and WOOHOO preference types to a Sim.',
    command_arguments=(
        CommonConsoleCommandArgument('sim_info', 'Sim Id or Name', 'The instance id or name of the Sim to change.', is_optional=True, default_value='Active Sim'),
    ),
)
def _ts4t_apply_default_gender_pref_to_sim(output: CommonConsoleCommandOutput, sim_info: SimInfo = None):
    if sim_info is None:
        return
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.apply_default_gender_pref_to_all_sims',
    'Apply the default Gender preference for ROMANTIC and WOOHOO preference types to all Sims using their Gender.'
)
def _ts4t_apply_default_gender_pref_to_all_sims(output: CommonConsoleCommandOutput):
