...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.hide_plumbob', 'Hide the plumbob above a Sim.', command_arguments=(
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.show_plumbob', 'Show the plumbob above a Sim.', command_arguments=(
