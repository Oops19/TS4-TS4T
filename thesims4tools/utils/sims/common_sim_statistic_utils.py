...
from thesims4tools.utils.common_component_utils import CommonComponentUtils
...
from thesims4tools.utils.resources.common_statistic_utils import CommonStatisticUtils
...
commands_log = CommonLogRegistry().register_log(ModInfo.get_identity(), 'ts4t_statistic_commands')
commands_log.enable()
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.print_stat_value',
        'ts4t.printstatvalue',
        'ts4t.printstatisticvalue'
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.set_statistic_user_value',
        'ts4t.set_stat_level',
        'ts4t.setstatlevel',
        'ts4t.setstatisticlevel'
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.print_statistic_user_value',
        'ts4t.print_stat_level',
        'ts4t.printstatlevel',
        'ts4t.printstatisticlevel'
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.remove_commodity',
        'ts4t.remove_stat',
        'ts4t.removestat',
        'ts4t.removestatistic'
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.print_static_commodities',
    'Print a list of a Static Commodities on a Sim.',
    command_arguments=(
        CommonConsoleCommandArgument('sim_info', 'Sim Id or Name', 'The name or instance id of the Sim to check.', is_optional=True, default_value='Active Sim'),
    ),
    command_aliases=(
        'ts4t_testing.printstaticcommodities',
    )
)
