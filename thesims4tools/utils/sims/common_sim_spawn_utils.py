...
from thesims4tools.classes.math.common_surface_identifier import CommonSurfaceIdentifier
...
from thesims4tools.utils.cas.common_cas_utils import CommonCASUtils
from thesims4tools.utils.cas.common_outfit_utils import CommonOutfitUtils
from thesims4tools.utils.common_date_utils import CommonRealDateUtils
...
from thesims4tools.utils.common_time_utils import CommonTimeUtils
from thesims4tools.utils.math.common_bitwise_utils import CommonBitwiseUtils
from thesims4tools.utils.resources.common_game_pack_utils import CommonGamePackUtils
from thesims4tools.utils.sims.common_age_utils import CommonAgeUtils
from thesims4tools.utils.sims.common_household_utils import CommonHouseholdUtils
from thesims4tools.utils.sims.common_sim_death_utils import CommonSimDeathUtils
...
log = CommonLogRegistry().register_log(ModInfo.get_identity(), 'ts4t_spawn_utils')
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_sims', 'Spawn Sims of a certain species, gender, and age.', command_arguments=(
...
def _ts4t_spawn_sims(output: CommonConsoleCommandOutput, species: CommonSpecies, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    if species is None:
        return
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_human_sims', 'Spawn Human Sims of a certain gender and age.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=1),
    CommonConsoleCommandArgument('gender', 'CommonGender',
                                 f'The spawned Sims will have this gender. Valid genders include: {CommonGender.get_comma_separated_names_string()}', is_optional=True, default_value=CommonGender.MALE.name if hasattr(CommonGender.MALE, 'name') else CommonGender.MALE),
    CommonConsoleCommandArgument('age', 'CommonAge',
...
def _ts4t_spawn_human_sims(output: CommonConsoleCommandOutput, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    return _ts4t_spawn_sims(output, CommonSpecies.HUMAN, count=count, gender=gender, age=age)


@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_large_dog_sims', 'Spawn Large Dog Sims of a certain gender and age.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=1),
    CommonConsoleCommandArgument('gender', 'CommonGender',
                                 f'The spawned Sims will have this gender. Valid genders include: {CommonGender.get_comma_separated_names_string()}', is_optional=True, default_value=CommonGender.MALE.name if hasattr(CommonGender.MALE, 'name') else CommonGender.MALE),
    CommonConsoleCommandArgument('age', 'CommonAge',
...
def _ts4t_spawn_large_dog_sims(output: CommonConsoleCommandOutput, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    return _ts4t_spawn_sims(output, CommonSpecies.LARGE_DOG, count=count, gender=gender, age=age)


@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_small_dog_sims', 'Spawn Small Dog Sims of a certain gender and age.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=1),
    CommonConsoleCommandArgument('gender', 'CommonGender',
                                 f'The spawned Sims will have this gender. Valid genders include: {CommonGender.get_comma_separated_names_string()}', is_optional=True, default_value=CommonGender.MALE.name if hasattr(CommonGender.MALE, 'name') else CommonGender.MALE),
    CommonConsoleCommandArgument('age', 'CommonAge',
...
def _ts4t_spawn_small_dog_sims(output: CommonConsoleCommandOutput, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    return _ts4t_spawn_sims(output, CommonSpecies.SMALL_DOG, count=count, gender=gender, age=age)


@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_cat_sims', 'Spawn Cat Sims of a certain gender and age.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=1),
    CommonConsoleCommandArgument('gender', 'CommonGender',
                                 f'The spawned Sims will have this gender. Valid genders include: {CommonGender.get_comma_separated_names_string()}', is_optional=True, default_value=CommonGender.MALE.name if hasattr(CommonGender.MALE, 'name') else CommonGender.MALE),
    CommonConsoleCommandArgument('age', 'CommonAge',
...
def _ts4t_spawn_cat_sims(output: CommonConsoleCommandOutput, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    return _ts4t_spawn_sims(output, CommonSpecies.CAT, count=count, gender=gender, age=age)


@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_fox_sims', 'Spawn Fox Sims of a certain gender and age.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=1),
    CommonConsoleCommandArgument('gender', 'CommonGender',
                                 f'The spawned Sims will have this gender. Valid genders include: {CommonGender.get_comma_separated_names_string()}', is_optional=True, default_value=CommonGender.MALE.name if hasattr(CommonGender.MALE, 'name') else CommonGender.MALE),
    CommonConsoleCommandArgument('age', 'CommonAge',
...
def _ts4t_spawn_fox_sims(output: CommonConsoleCommandOutput, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    return _ts4t_spawn_sims(output, CommonSpecies.FOX, count=count, gender=gender, age=age)


@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_horse_sims', 'Spawn Horse Sims of a certain gender and age.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=1),
    CommonConsoleCommandArgument('gender', 'CommonGender',
                                 f'The spawned Sims will have this gender. Valid genders include: {CommonGender.get_comma_separated_names_string()}', is_optional=True, default_value=CommonGender.MALE.name if hasattr(CommonGender.MALE, 'name') else CommonGender.MALE),
    CommonConsoleCommandArgument('age', 'CommonAge',
...
def _ts4t_spawn_horse_sims(output: CommonConsoleCommandOutput, count: int = 1, gender: CommonGender = CommonGender.MALE, age: CommonAge = CommonAge.ADULT):
    return _ts4t_spawn_sims(output, CommonSpecies.HORSE, count=count, gender=gender, age=age)


@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.spawn_random_sims', 'Spawn a random number of Sims.', command_arguments=(
    CommonConsoleCommandArgument('count', 'Number', 'The number of Sims to spawn.', is_optional=True, default_value=5),
))
def _ts4t_spawn_random_sims(output: CommonConsoleCommandOutput, count: int = 5):
    _ts4t_spawn_human_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.TODDLER)
    _ts4t_spawn_human_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.CHILD)
    _ts4t_spawn_human_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.ADULT)

    _ts4t_spawn_human_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.TODDLER)
    _ts4t_spawn_human_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.CHILD)
    _ts4t_spawn_human_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.ADULT)

    _ts4t_spawn_large_dog_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.CHILD)
    _ts4t_spawn_large_dog_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.ADULT)

    _ts4t_spawn_large_dog_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.CHILD)
    _ts4t_spawn_large_dog_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.ADULT)

    _ts4t_spawn_small_dog_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.CHILD)
    _ts4t_spawn_small_dog_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.ADULT)

    _ts4t_spawn_small_dog_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.CHILD)
    _ts4t_spawn_small_dog_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.ADULT)

    _ts4t_spawn_cat_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.CHILD)
    _ts4t_spawn_cat_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.ADULT)

    _ts4t_spawn_cat_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.CHILD)
    _ts4t_spawn_cat_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.ADULT)

    _ts4t_spawn_fox_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.ADULT)
    _ts4t_spawn_fox_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.ADULT)

    _ts4t_spawn_horse_sims(output, count=count, gender=CommonGender.MALE, age=CommonAge.CHILD)
    _ts4t_spawn_horse_sims(output, count=count, gender=CommonGender.FEMALE, age=CommonAge.ADULT)
...
def _ts4t_purge_self(output: CommonConsoleCommandOutput):
    active_sim_info = CommonSimUtils.get_active_sim_info()
...
def _ts4t_purge_sim(output: CommonConsoleCommandOutput, sim_info: SimInfo):
    if sim_info is None:
        return
    if sim_info is CommonSimUtils.get_active_sim_info():
        output('Failed, If you want to purge the active Sim, use "ts4t.purge_self" instead.')
        return
...
def _ts4t_be_alone(output: CommonConsoleCommandOutput):
    active_sim_info = CommonSimUtils.get_active_sim_info()
...
def _ts4t_purge_neighborhood(output: CommonConsoleCommandOutput):
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.purge_non_household',
    'Purge all Sims outside of the active household.'
)
def _ts4t_purge_non_household(output: CommonConsoleCommandOutput):
