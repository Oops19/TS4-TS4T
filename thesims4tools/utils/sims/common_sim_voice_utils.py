...
from thesims4tools.enums.common_voice_actor_type import CommonVoiceActorType
...
class CommonSimVoiceUtils:
    ...
    def set_to_default_male_voice(sim_info: SimInfo) -> CommonExecutionResult:
        ...
        :rtype: CommonExecutionResult
        """
        from thesims4tools.utils.sims.common_age_species_utils import CommonAgeSpeciesUtils
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_dev.print_all_voice_actors',
