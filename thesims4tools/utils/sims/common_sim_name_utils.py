...
from thesims4tools.enums.common_sim_name_type import CommonSimNameType
...
from thesims4tools.utils.misc.common_text_utils import CommonTextUtils
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.randomize_name', 'Randomize the first and last names of a Sim.', command_arguments=(
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.set_first_name', 'Set the first name of a Sim.', command_arguments=(
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.randomize_first_name', 'Randomize the first name of a Sim.', command_arguments=(
    CommonConsoleCommandArgument('sim_info', 'Sim Id or Name', 'The Sim to change the first name of.'),
    CommonConsoleCommandArgument('sim_name_type', 'CommonSimNameType', f'Determines from which list of names to randomize the name from. Valid Values: {CommonSimNameType.get_comma_separated_names_string()}'),
))
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.set_last_name', 'Set the last name of a Sim.', command_arguments=(
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.randomize_last_name', 'Randomize the last name of a Sim.', command_arguments=(
    CommonConsoleCommandArgument('sim_info', 'Sim Id or Name', 'The Sim to change the last name of.'),
    CommonConsoleCommandArgument('sim_name_type', 'CommonSimNameType', f'Determines from which list of names to randomize the name from. Valid Values: {CommonSimNameType.get_comma_separated_names_string()}'),
))
...
@CommonConsoleCommand(ModInfo.get_identity(), 'ts4t.set_name', 'Set the full name of a Sim.', command_arguments=(
    CommonConsoleCommandArgument('first_name', 'Text', 'The first name to give to the Sim.'),
    CommonConsoleCommandArgument('last_name', 'Text', 'The last name to give to the Sim.'),
