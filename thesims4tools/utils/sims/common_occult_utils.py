...
from thesims4tools.utils.sims.common_sim_appearance_modifier_utils import CommonSimAppearanceModifierUtils
from thesims4tools.utils.sims.common_sim_bucks_utils import CommonSimBucksUtils
from thesims4tools.utils.sims.common_sim_loot_action_utils import CommonSimLootActionUtils
from thesims4tools.utils.sims.common_sim_spell_utils import CommonSimSpellUtils
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.switchsimtooccult',
        'ts4t.switchoccult',
        'ts4t.switch_occult',
        'ts4t.switch_occult_type',
        'ts4t.switchocculttype'
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.addalloccultstosim',
        'ts4t.add_all_occults',
        'ts4t.addalloccults',
        'ts4t.add_all_occults_type',
        'ts4t.addalloccultstype',
    )
)
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.remove_all_occults_from_sim',
    ...
    command_aliases=(
        'ts4t.removealloccultsfromsim',
        'ts4t.remove_all_occults',
        'ts4t.removealloccults',
        'ts4t.remove_all_occults_type',
        'ts4t.removealloccultstype',
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.removeoccultfromsim',
        'ts4t.remove_occult',
        'ts4t.removeoccult',
        'ts4t.remove_occult_type',
        'ts4t.removeocculttype',
    )
)
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        ...
        'ts4t.remove_all_occults',
        'ts4t.removealloccults',
        'ts4t.remove_all_occult_types',
        'ts4t.removeallocculttypes',
    )
)
def _common_remove_all_occults_from_sim(output: CommonConsoleCommandOutput, sim_info: SimInfo = None):
    if sim_info is None:
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_dev.print_vanilla_occults',
    ...
    command_aliases=(
        'ts4t_dev.printvanillaoccults',
    ),
    show_with_help_command=False
)
def _ts4t_testing_print_vanilla_occult_types_for_sim(output: CommonConsoleCommandOutput, sim_info: SimInfo = None):
    if sim_info is None:
        return
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.print_occult_sim_infos',
    ...
    command_aliases=(
        'ts4t_testing.printoccultsiminfos',
    )
)
