...
class CommonSimSpellUtils:
    ...
    def add_spells(cls, sim_info: SimInfo, spells: Tuple[Union[int, Spell]], mark_as_new: bool = True) -> CommonExecutionResult:
        ...
        :rtype: CommonExecutionResult
        """
        from thesims4tools.utils.sims.common_sim_unlock_utils import CommonSimUnlockUtils
...
@CommonConsoleCommand(
    ...
    command_aliases=(
        'ts4t.remove_spells',
        'ts4t.lock_all_spells',
        'ts4t.unlearn_all_spells',
    )
)
