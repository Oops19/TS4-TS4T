...
from thesims4tools.utils.misc.common_game_client_utils import CommonGameClientUtils
...
class CommonSimUtils:
    ...
    .. note::
        ...
        - `ts4t_testing.display_name_of_currently_active_sim`
        - `ts4t_testing.display_names_of_all_sims`
...
@CommonConsoleCommand(
    ...
    'ts4t_testing.print_name_of_sim',
...
def _ts4t_testing_print_name_of_sim(output: CommonConsoleCommandOutput, sim_info: SimInfo = None):
    # noinspection PyPropertyAccess
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t_testing.print_names_of_all_sims',
    'Print a list of the first and last names of all Sims.'
)
def _ts4t_testing_print_names_of_all_sims(output: CommonConsoleCommandOutput):
