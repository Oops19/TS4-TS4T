...
@CommonConsoleCommand(
    ...
    'ts4t.attach_cas_part_to_all_outfits',
    ...
    command_aliases=(
        'ts4t.attachcasparttoalloutfits',
    )
)
def _ts4t_attach_cas_part_to_all_outfits(output: CommonConsoleCommandOutput, cas_part_id: int, body_type: str = 'any', sim_info: SimInfo = None):
    if sim_info is None:
        return
    if cas_part_id < 0:
...
def _ts4t_attach_cas_part(output: CommonConsoleCommandOutput, cas_part_id: int, body_type: str = 'any', sim_info: SimInfo = None):
    if sim_info is None:
        return
    if cas_part_id < 0:
        output('ERROR: CAS Part must be a positive number.')
...
def _ts4t_detach_cas_part(output: CommonConsoleCommandOutput, cas_part_id: int, body_type: str = 'all', sim_info: SimInfo = None):
    if sim_info is None:
        return
    if cas_part_id < 0:
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    'ts4t.print_cas_part_at_body_type',
...
def _ts4t_print_cas_part_at_body_type(output: CommonConsoleCommandOutput, body_type: str, sim_info: SimInfo = None):
    if sim_info is None:
        return
    if body_type is None:
        output('ERROR: No Body Type was specified.')
...
def _ts4t_is_cas_part_available(output: CommonConsoleCommandOutput, cas_part_id: int):
