...
class CommonModInfo(CommonService):
    ...
    .. code-block:: python
        ...
        from thesims4tools.mod_support.common_mod_info import CommonModInfo

        # This is how the thesims4tools.modinfo.ModInfo implementation works.
